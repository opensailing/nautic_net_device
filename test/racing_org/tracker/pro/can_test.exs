defmodule RacingOrg.Tracker.Pro.CANTest do
  use ExUnit.Case
  ...
  setup do
    ...
    start_supervised!(
      {RacingOrg.Tracker.Pro.CAN,
       driver: RacingOrg.Tracker.Pro.CAN.Fake.Driver,
       handlers: [
         {RacingOrg.Tracker.Pro.PacketHandler.Callbacks,
  ...
  defp replay_until_completion(log, timeout \\ 5000) do
    :ok = RacingOrg.Tracker.Pro.CAN.Fake.Driver.replay_canusb_log(log)
